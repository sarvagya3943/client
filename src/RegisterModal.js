...
import {
	DialogTitle, withStyles, DialogContent, TextField, Typography, InputAdornment, FormControl,
...
class RegisterModal extends React.Component {
	...
	check = () => {
		...
		Object.keys(this.state.errors).forEach(key => {
			if(this.state.errors[key] !== "") formOk = false ;
		})
		if(!formOk) {
					...
					<DialogContent className={classes.container}>
						<form className={classes.Form}>
							...
							<FormControl className={classes.form_control}>
								<RadioGroup value={this.state.user.gender} onChange={this.handleChange} name="gender" className={classes.radio_group}>
									<FormControlLabel value="Male" label="Male" control={<Radio />} />
									<FormControlLabel value="Female" label="Female" control={<Radio />} />
									<FormControlLabel value="Other" label="Other" control={<Radio />} />
								</RadioGroup>
							</FormControl>
							<Button onClick={this.check} variant="raised" className={classes.registerButton} size="large">
								SIGN-UP
							</Button>
